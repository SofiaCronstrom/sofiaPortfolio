   ...
   <header className="wrapper-about">
       ...
       <div className="profile-container">
         ...
         <div className="text-head">
           <h2>Hi!</h2>
              <p className="me-text">
              My name is Sofia and I am a 36 year old woman based in Stockholm, Sweden.<br/> After studying and practicing art for some years I embarked on a new path in life as a frontend developer. 
              <br/>
